...
include::{snippets}/board-controller-test/read-board/http-request.adoc[]

==== Example response

include::{snippets}/board-controller-test/read-board/http-response.adoc[]

==== CURL request

include::{snippets}/board-controller-test/read-board/curl-request.adoc[]
...
include::{snippets}/board-controller-test/delete-board/http-response.adoc[]

==== CURL request

include::{snippets}/board-controller-test/delete-board/curl-request.adoc[]
...
include::{snippets}/board-controller-test/update-board/http-request.adoc[]

==== Request Body

include::{snippets}/board-controller-test/update-board/request-body.adoc[]
...
include::{snippets}/board-controller-test/update-board/curl-request.adoc[]